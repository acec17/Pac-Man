 ...
 * @author S331473306
 */
public class NinjaGhost extends Player implements Runnable{
    ...
    public NinjaGhost(int lives, int xAxis, int yAxis, String image, boolean isAlive, Level1 lvl1, Player pacman) {
    ...
    public void run() {
       while(true){
           ...
           if(getyAxis() <= 60){
               direction = 1;
               setImage("images//ninjaGhostRight.png");
           
           }else if(getyAxis() >= 400){
               direction = -1;
               setImage("images//ninjaGhostLeft.png");
