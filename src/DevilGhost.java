 ...
 * @author S331473306
 */
public class DevilGhost extends Player implements Runnable{
    ...
    public DevilGhost(int lives, int xAxis, int yAxis, String image, boolean isAlive, Level1 lvl1, Player pacman) {
    ...
    public void run() {
       while(true){
           ...
           if(getxAxis() <= 180){
               direction = 1;
               setImage("images//devilGhostRight.png");
           
           }else if(getxAxis() >= 600){
               direction = -1; 
               setImage("images//devilGhostLeft.png");
