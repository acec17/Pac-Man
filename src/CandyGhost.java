 ...
 * @author S331473306
 */
public class CandyGhost extends Player implements Runnable{
    ...
    public CandyGhost(int lives, int xAxis, int yAxis, String image, boolean isAlive, Level1 lvl1, Player pacman) {
    ...
    public void run() {
       while(true){
           ...
           if(getxAxis() <= 60){
               direction = 1;
               setImage("images//candyGhostRight.png");
           
           }else if(getxAxis() >= 720){
               direction = -1;
               setImage("images//candyGhostLeft.png");
